...
<div class="card">
	<div class="card-header header-elements-inline">
		<h5 class="card-title font-weight-bold">View User</h5>
	...
	<div class="card-body">
		...
		<div class="text-right mb-1">
			<button type="submit" value="Cancel"
				...
				class="btn btn-sm btn-default">Back</button>			
		</div>
	</div>
</div>
<script type="text/javascript">
	$(document).ready(function() {		
		...
		$('#assignDiv').hide();
		fillSubDepartmentMaritimeBoardByState('stateId', 'departmentId','boardId','organisationId','portId');
		...
		setTimeout(function(){			
			$('#roleId').val('${userDetail.role.roleId}').change();
		...
		//document.getElementById("assignProjectId").disabled = true;
