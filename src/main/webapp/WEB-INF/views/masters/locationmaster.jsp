...
<script type="text/javascript">
	$(document).ready(function() {
		listLocationMasterData(0,10);
	});
	function clearName() {
		var a = document.getElementById("locationName");
			...
			<form id=" ">
						...
						<div class="col-md-6 float-left">
							<fieldset>
								<div class="form-group row">
									...
									<div class="col-md-9">
										<input class="form-control" type="text" id="bylocation" onkeydown="validateMastersName(event)"/>
									</div>
								</div>
							</fieldset>
						</div>
				...
				<div class="col-sm-12">
					<div class="text-right mb-1">
						<button type="button" onclick="listLocationMasterData(0,10)" class="btn btn-primary">
				...
				<form action="#" class="form-horizontal">
					<div class="modal-body">
						...
						<div class="form-group row">
							...
							<div class="col-sm-9">
								<input type="text" id="locationName" placeholder=" " class="form-control" onkeypress="validateMastersName(event)" ondrag="return false"
									ondrop="return false">
							</div>
						</div>
					</div>
					...
					<div class="modal-footer">
						...
						<button type="button" class="btn bg-primary" onclick="createLocationMaster()">Submit</button>
					</div>
				</form>
			</div>
		</div>
