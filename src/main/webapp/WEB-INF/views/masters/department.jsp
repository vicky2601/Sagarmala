...
<script type="text/javascript">
	$(document).ready(function() {
		listDepartmentData(0,10);
	});
	function clearName() {
		var a = document.getElementById("departmentName");
			...
			<div class="col-sm-12">
				...
				<div class="col-md-6 float-left">
				     <fieldset>
						<div class="form-group row">
							...
							<div class="col-md-9">
								 <input class="form-control" type="text" id="departmentId" onkeydown="validateMastersName(event)"/>
							</div>
						</div>
					</fieldset>
				</div> 
			 ...
			 <div class="col-sm-12"> 
					 <div class="text-right mb-1">
						 <button type="button" class="btn btn-primary" onclick="listDepartmentData(0,10)"><i class="icon-search4"></i> </button>
					 </div> 
			 </div>
			 <div class="col-sm-12">
			<div class="form-group row">
						...
						<!-- 	<thead>
							...
							<tbody>
								<!-- <tr>
									...
									<td> </td>
									<td> </td>
									<td><button class="btn btn-sm btn-info" onclick="onClickfunction();"><i class="fa fa-edit"></i></button></td> 
							...
							<form action="#" class="form-horizontal">
								<div class="modal-body">
									...
									<div class="form-group row">
										...
										<div class="col-sm-9">
											<input type="text" placeholder=" " class="form-control" id="departmentName" onkeydown="validateMastersName(event)">
										</div>
									</div> 
								</div>
								...
								<div class="modal-footer">
									...
									<button type="button" class="btn bg-primary" onclick="createDepartment()">Submit </button>
								</div>
							</form>
						</div>
					</div>
