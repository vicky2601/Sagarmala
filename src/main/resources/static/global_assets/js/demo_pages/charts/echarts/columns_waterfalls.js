    ...
    var _columnsWaterfallsExamples = function() {
        ...
        if (columns_basic_element) {
            ...
            columns_basic.setOption({
                ...
                // Add legend
                legend: {
                    data: ['Fund Requested (Rs. Cr)','Fund Sanctioned (Rs. Cr)', 'Fund Released (Rs. Cr)'],
                    itemHeight: 8,
                    itemGap: 20,
                    textStyle: {
                        padding: [0, 5]
                ...
                xAxis: [{
                    type: 'category',
                    data: ['Port Modernization', 'Coastal Community Development', 'Port-Led Industrialization', 'Port Connectivity'],
                    axisLabel: {
                        color: '#333'
                    },
                    axisLine: {
                ...
                series: [
				{
                        name: 'Fund Requested (Rs. Cr)',
                        type: 'bar',
                        data: [666, 200, 568, 224],
                        itemStyle: {
                            normal: {
                                label: {
                                    show: true,
        ...
        if (columns_stacked_element) {
            ...
            columns_stacked.setOption({
                ...
                xAxis: [{
                    type: 'category',
                    data: ['2017-18', '2018-19', '2019-20', 'After 2020'],
                    axisLabel: {
                        color: '#333'
                    },
                    axisLine: {
                ...
                series: [                                        
                    {
                        name: 'Capacity Addition Planned',
                        type: 'bar',
                        stack: 'Advertising',
                        data: [1300, 1451, 1570, 1636]
                    },
                    {
                        name: 'Capacity Addition Achieved',
                        type: 'bar',
                        stack: 'Advertising',
                        data: [1000, 500, 966, 1084]
                    }					
                ]
            });
        }
