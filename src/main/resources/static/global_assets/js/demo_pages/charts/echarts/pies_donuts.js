        ...
        if (pie_basic_element) {
            ...
            pie_basic.setOption({
                ...
                legend: {
                    ...
                    top: 'bottom',
                    left: 0,
                    data: ['No Delay', 'Delayed < 3 months', 'Delayed 3-6 months', 'Delayed 6-12 months', 'Delayed > 1 year'],
                    itemHeight: 8,
                    itemWidth: 8
                },
                ...
                series: [{
                    ...
                    data: [
                        {value: 548, name: 'No Delay'},
                        {value: 310, name: 'Delayed < 3 months'},
                        {value: 234, name: 'Delayed 3-6 months'},
                        {value: 135, name: 'Delayed 6-12 months'},
                        {value: 335, name: 'Delayed > 1 year'}
                    ]
                }]
            });
        }
