...
public class OgatizationMaster implements Serializable{
	...
	public String toString() {
		return "OgatizationMaster [masterId=" + masterId + ", masterName=" + masterName + ", masterCode=" + masterCode
				+ ", masterUniquecode=" + masterUniquecode + ", createdBy=" + createdBy + ", updatedBy=" + updatedBy
